...
export class Code {
    ...
    gen(): string {
        ...
        */
        let reduced = reduceDigits(parseInt(`${multiplicateOfFirstNumber}${multiplicateOfSecondNumber}${multiplicateOfThirdNumber}`));
        ...
        */
        /*
            ...
            reduced = 2
        */
        if (parseInt(reduced.toString()[0]) + parseInt(reduced.toString()[1]) > 12) reduced = Math.round(reduced / 9);
    ...
    validate(): boolean {
        ...
        if (reduceDigits(csi[0]) != 12 || reduceDigits(csi[1]) != 12 || reduceDigits(csi[2]) != 12 || reduceDigits(csi[3]) != 12) return false;
        ...
        /* 
            ...
            reduced = reduceDigits(146320896) --> 1+4+6+3+2+0+8+9+6=39
        */
        let reduced = parseInt(`${multiplicateOfFirstNumber}${multiplicateOfSecondNumber}${multiplicateOfThirdNumber}`);
