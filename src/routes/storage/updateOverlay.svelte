...
<div class="inner-overlay">
	...
	<form onsubmit={handleSubmit}>
		...
		<input
			type="hidden"
			name="product-sold-to-org"
			id="product-sold-to-org"
			value={product.soldToOrgN}
		/>
		<input
			type="hidden"
			name="product-sold-to-part"
			id="product-sold-to-part"
			value={product.soldToPartN}
		/>
		<input
			type="hidden"
			name="product-taken-out"
			id="product-taken-out"
			value={product.takenOutN}
		/>
		...
		<div class="form-label">
			<label for="barcode" class="barcode"> Vonalkód </label>
